...
# ---------------- DISPLAY -----------------
display = StringVar()
entry = Entry(root, textvariable=display, font=("Arial", 20),
              bg="black", fg="white", insertbackground="white")
entry.grid(row=0, column=0, columnspan=6, ipadx=80, ipady=15, padx=10, pady=10)
...
Button(root, text="Clear History", bg="#660000", fg="white", command= clear_history, width=10).grid(row=6, column=5)
